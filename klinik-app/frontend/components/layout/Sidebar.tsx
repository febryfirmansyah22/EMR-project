      ...
      >
        ...
        <div className="h-16 flex items-center justify-between px-5 border-b border-slate-200 dark:border-slate-700">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <p className="font-bold text-slate-900 text-sm leading-tight dark:text-slate-100">
                Klinik App
              </p>
          ...
          <button
            onClick={onClose}
            className="lg:hidden p-1.5 hover:bg-slate-100 rounded-lg dark:hover:bg-slate-700"
          >
